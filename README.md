...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .screen { display: none; text-align: center; animation: fadeIn 0.5s ease-in-out; }
        ...
        .btn { background: #ff69b4; color: white; border: none; padding: 16px; border-radius: 50px; font-size: 1.1rem; font-weight: bold; width: 100%; margin-top: 15px; box-shadow: 0 5px 15px rgba(255, 105, 180, 0.3); cursor: pointer; }
        .photo-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin: 15px 0; }
        .photo-grid img { width: 100%; height: 160px; object-fit: cover; border-radius: 10px; border: 4px solid #fff; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
        .video-box { width: 100%; margin-bottom: 20px; background: #000; border-radius: 15px; overflow: hidden; border: 2px solid #ffb6c1; aspect-ratio: 9/16; }
        iframe { width: 100%; height: 100%; border: none; }
        .letter-content { text-align: left; font-size: 0.95rem; line-height: 1.7; padding: 15px; background: #fffafb; border-radius: 15px; max-height: 450px; overflow-y: auto; white-space: pre-line; border-left: 5px solid #ff69b4; color: #444; }
...
<div class="mobile-container">
    ...
    <div id="v1" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/1KJUT3jNxH10EEdlHUZO-rQ_juQbfV-Ov/preview"></iframe></div><button class="btn" onclick="show('v2')">Next Video ✨</button></div>
    <div id="v2" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/1rHikV2ia4Dh8sddrcn8u54Z18HsGDfAo/preview"></iframe></div><button class="btn" onclick="show('v3')">Next Video ✨</button></div>
    <div id="v3" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/1a-7kXpd6EMq7zGIIgX7GlC6gMIQNcztM/preview"></iframe></div><button class="btn" onclick="show('v4')">Next Video ✨</button></div>
    <div id="v4" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/1q_xc4axTytBExwOpwlYU4gpra6WHTMt6/preview"></iframe></div><button class="btn" onclick="show('v5')">Next Video ✨</button></div>
    <div id="v5" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/133glT6xC8dVyjcCNrLBTvCr5rSy8aAtv/preview"></iframe></div><button class="btn" onclick="show('v6')">Last Video ✨</button></div>
    <div id="v6" class="screen"><h1>For You 🫶🏻💗</h1><div class="video-box"><iframe src="https://drive.google.com/file/d/1ompKdCqZo51LkXg_e-Y4ytFndp83v6sy/preview"></iframe></div><button class="btn" onclick="show('p5')">Read My Letter 💌</button></div>
